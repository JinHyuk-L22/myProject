...
function loadItems() {
  ...
  var item = performLfmRequest('jsonitems', {show_list: function () {return show_list;}, sort_type: function () {return sort_type;}}, 'html');
  console.dir(item);

  performLfmRequest('jsonitems', {show_list: function () {return show_list;}, sort_type: function () {return sort_type;}}, 'html')
    .done(function (data) {
      var response = JSON.parse(data);
